...
const GetStartedScreen = () => {
    ...
    return (
        <View className="flex-1 flex-col items-center justify-center">
            ...
            <Text className="p-2.5 text-[#39C7A5] text-lg">Find your fit today</Text>
            <TouchableOpacity
            ...
            <View className="flex-1 absolute bottom-16 text-[#444]">
                <Text>Already have an account? <Text className="font-semibold underline text-[#39C7A5]" onPress={()=>navigation.navigate('Login')}>Log in</Text></Text>
            </View> 
        </View>
    )
}
